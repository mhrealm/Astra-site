---
title: '虚拟滚动真的比普通滚动性能更好吗？'
description: '从普通列表和虚拟列表的实现讲起，对比不同数据量下的渲染、脚本和绘制成本。'
pubDate: '2025-11-19'
category: '性能优化'
categorySlug: 'performance'
tags: ['Virtual List', 'Vue']
difficulty: 4
source: 'vue-practice/src/views/performance/virtual-list'
demoSlug: 'virtual-scroll-performance'
---

import LazyNormalList from './LazyNormalList.vue'
import VirtualList from './VirtualList.vue'
import moveYImage from './image.png'
import virtualListImage from './image-1.png'
import normalPerf100kImage from './image-2.png'
import normalListImage from './image-3.png'
import virtualPerf100kImage from './image-4.png'
import virtualPerf10kImage from './image-5.png'
import normalPerf10kImage from './image-6.png'
...
<LazyNormalList client:visible />

<img src={normalListImage.src} alt="普通滚动列表截图" />
...
<VirtualList client:visible />

<img src={virtualListImage.src} alt="虚拟滚动列表截图" />
...
如果位置没有被补回来，就会出现“数据已经是索引 10，位置却还是索引 0”的错位问题。

<img src={moveYImage.src} alt="moveY 作用图解" />
...
<img src={normalPerf100kImage.src} alt="十万条数据普通滚动 Performance 截图" />
...
<img src={virtualPerf100kImage.src} alt="十万条数据虚拟滚动 Performance 截图" />
...
<img src={normalPerf10kImage.src} alt="一万条数据普通滚动 Performance 截图" />
...
<img src={virtualPerf10kImage.src} alt="一万条数据虚拟滚动 Performance 截图" />
